...
```
Nota: Se a execução travar em ambientes de nuvem, excluaa interface de loopback anexando --mca btl_tcp_if_exclude lo --mca oob_tcp_if_exclude lo ao seu comando.
